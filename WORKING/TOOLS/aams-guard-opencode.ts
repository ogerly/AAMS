# source: aams-guard-pattern (WH-009)
# AAMS Guard — OpenCode Plugin (Reference Implementation)
#
# This is a local_adaptation of the AAMS Guard-Pattern (WH-009).
# AAMS describes WHAT to check, not HOW. Each tool implements differently.
#
# Installation: Copy to .opencode/plugin/aams-guard.ts in your project.
# Usage: OpenCode will auto-load this plugin on session start.
